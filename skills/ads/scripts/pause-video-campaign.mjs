 ...
 *
 * Usage:
 *   node pause-video-campaign.mjs --campaign-id 12345678
 *   node pause-video-campaign.mjs --campaign-id 12345678 --reason "replaced by new version"
 *   node pause-video-campaign.mjs --mdx apps/buda/content/videos/zh-CN/buda-intro-general.mdx
 */
...
if (!campaignIdArg && !mdxPath) {
  console.error(
    [
      "Usage: node pause-video-campaign.mjs [options]",
      "",
