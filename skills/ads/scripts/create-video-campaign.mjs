 ...
 *
 * Usage:
 *   node create-video-campaign.mjs --mdx apps/buda/content/videos/zh-CN/buda-intro-general.mdx
 *   node create-video-campaign.mjs --mdx <mdx> --dry-run
 *   node create-video-campaign.mjs --mdx <mdx> --force
 */
...
if (!mdxPath) {
  console.error(
    [
      "Usage: node create-video-campaign.mjs --mdx <mdx-file> [options]",
      "",
      "Options:",
